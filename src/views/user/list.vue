    ...
    <el-dialog v-model="detailDialogVisible" title="会员详情" width="700px">
      <el-descriptions :column="2" border v-if="currentMember">
        ...
        <el-descriptions-item label="性别">{{
          genderMap[currentMember.gender] || '未知'
        }}</el-descriptions-item>
        ...
        <el-descriptions-item label="会员等级">
          <el-tag type="warning">{{
            memberLevelMap[currentMember.memberLevel] || '普通会员'
          }}</el-tag>
        </el-descriptions-item>
        ...
        <el-descriptions-item label="余额">
          <span style="color: #e1251b; font-weight: bold"
        ...
        <el-descriptions-item label="最后登录">{{
          currentMember.lastLoginTime || '-'
        }}</el-descriptions-item>
        <el-descriptions-item label="个性签名" :span="2">{{
          currentMember.personalizedSignature || '无'
        }}</el-descriptions-item>
      </el-descriptions>
    </el-dialog>
  </div>
